...
public class TaggedLocation implements org.apache.thrift.TBase<TaggedLocation, TaggedLocation._Fields>, java.io.Serializable, Cloneable, Comparable<TaggedLocation>, android.os.Parcelable {
  ...
  public TaggedLocation(android.os.Parcel in) {
    //primitive bitfield of type: byte
    __isset_bitfield = in.readByte();

    this.uid = in.readLong();
    this.location= in.readParcelable(TaggedLocation.class.getClassLoader());
    this.votes = in.readInt();
  }

  public static final android.os.Parcelable.Creator<TaggedLocation> CREATOR = new android.os.Parcelable.Creator<TaggedLocation>() {
    @Override
    public TaggedLocation[] newArray(int size) {
      return new TaggedLocation[size];
    }

    @Override
    public TaggedLocation createFromParcel(android.os.Parcel in) {
      return new TaggedLocation(in);
    }
  };
