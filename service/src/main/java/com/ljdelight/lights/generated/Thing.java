...
public class Thing implements org.apache.thrift.TBase<Thing, Thing._Fields>, java.io.Serializable,
                              Cloneable, Comparable<Thing> {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC =
            new org.apache.thrift.protocol.TStruct("Thing");
     ...
     * @see ThingType
     */
    public ThingType type; // required

    /** The set of fields this struct contains, along with convenience methods for finding and
     * manipulating them. */
    public enum _Fields implements org
    .apache.thrift.TFieldIdEnum {
        ID((short) 1, "id")
        ,
                /**
                 *
        ...
        tmpMap.put(_Fields.TYPE,
                new org.apache.thrift.meta_data.FieldMetaData("type",
                        ...
                        new org.apache.thrift.meta_data.EnumMetaData(
                                org.apache.thrift.protocol.TType.ENUM, ThingType.class)));
    ...
    public Thing(long id, ThingType type) {
        this();
        this.id = id;
        setIdIsSet(true);
        this.type = type;
    ...
    public boolean equals(Object that) {
        ...
        if (that instanceof Thing) return this.equals((Thing) that);
        return false;
    }
    ...
    public void validate() throws org.apache.thrift.TException {
        ...
        // alas, we cannot check 'id' because it's a primitive and you chose the non-beans
        // generator.
        if (type == null) {
    ...
    private static class ThingStandardScheme extends StandardScheme<Thing> {
        public void read(org.apache.thrift.protocol.TProtocol iprot, Thing struct)
                throws org.apache.thrift.TException {
                ...
                switch (schemeField.id) {
                    ...
                    case 2: // TYPE
                        if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                            struct.type = com.ljdelight.lights.generated.ThingType.findByValue(
                                    iprot.readI32());
        ...
        public void write(org.apache.thrift.protocol.TProtocol oprot, Thing struct)
                throws org.apache.thrift.TException {
            struct.validate();
    ...
    private static class ThingTupleScheme extends TupleScheme<Thing> {
        @Override
        public void write(org.apache.thrift.protocol.TProtocol prot, Thing struct)
                throws org.apache.thrift.TException {
        ...
        @Override
        public void read(org.apache.thrift.protocol.TProtocol prot, Thing struct)
                throws org.apache.thrift.TException {
            TTupleProtocol iprot = (TTupleProtocol) prot;
            struct.id = iprot.readI64();
            struct.setIdIsSet(true);
            struct.type = com.ljdelight.lights.generated.ThingType.findByValue(iprot.readI32());
            struct.setTypeIsSet(true);
        }
    }
}
